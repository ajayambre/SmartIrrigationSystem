package edu.pccoe.smartirrigationsys;
...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "sis@pccoe.com:hello", "bar@example.com:world"
    };
    /**
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                intent.setClass(getApplicationContext(), DisplayMenuActivity.class);
                String message = mEmailView.getText().toString();
                intent.putExtra("edu.pccoe.smartirrigationsys.MESSAGE", message);
